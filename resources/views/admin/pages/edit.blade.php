...
<div class="w-full bg-white rounded-lg shadow-lg text-slate-600 p-6">
    <form method="POST" action="{{ route('admin.page.update', $pages->id) }}" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="file" name="main_image" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer">
            @if ($pages->main_image)
   ...
   @endif
        ...
        <div class="mb-4">
            ...
            <input type="file" name="secondary_image" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer">
            @if ($pages->secondary_image)
                <img src="{{ asset('uploads/' . $pages->secondary_image) }}" alt="Secondary Image" class="mt-2 w-24">
            @endif
  ...
  <div class="mb-4">
        ...
        <div class="flex justify-end">
            ...
            <button type="submit" class="border mt-5 bg-[#4456a6] border-[#4456a6] px-4 py-2 rounded-md mr-2 text-white hover:bg-white transition duration-500 ease-in-out hover:text-[#4456a6]">
Update
            </button>
        </div>
    </form>
