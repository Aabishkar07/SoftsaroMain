...
<head>
    ...
    <style>
        ...
        .softsaro-logo .connected {
            position: relative;
        }

        .softsaro-logo .connected::after {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
...
<body>
    <!-- Watermark -->
    <div class="watermark">
        <div class="watermark-text softsaro-logo">softsaro</div>
    </div>
    ...
    <div class="page-container">
        ...
        <div class="header">
            ...
            <div class="company-logo">
                <div class="softsaro-logo">softsaro</div>
                {{-- <div class="company-name">SOFTSARO & CO.</div> --}}
            </div>
        </div>
        ...
        <div class="info-section">
            ...
            <div class="date-info">
                <div class="section-title">SOFTSARO & CO.</div>
        ...
        <div class="footer">
            <div class="payment-info">
                ...
                <div class="payment-details">
                    ...
                    <p><strong>Account Name:</strong> Softsaro Company</p>
                </div>
            </div>
            <div class="thank-you">
