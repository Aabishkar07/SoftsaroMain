    ...
    <div x-data="handleSwipe()" x-cloak
        ...
        <div>
            <nav class="mt-24">
                ...
                <a class="{{ request()->segment(2) == 'blogs' ? ' bg-[#6a68AF] text-white flex items-center px-6 py-2  mr-3 flex-1 mt-2 item ' : 'mr-3 flex-1 mt-2 item hover:bg-[#6a68AF] hover:text-white flex items-center px-6 py-2  text-gray-600' }} "
                    href="
                   {{ route('admin.blogs.index') }}
                     ">
                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-brand-blogger" width="24" height="24"
                ...
                <a class="{{ request()->segment(2) == 'settings' ? ' bg-[#6a68AF] text-white flex items-center px-6 py-2  mr-3 flex-1 mt-2 item ' : 'mr-3 flex-1 mt-2 item hover:bg-[#6a68AF] hover:text-white flex items-center px-6 py-2  text-gray-600' }} "
                ...
                <a class="{{ request()->segment(2) == 'teams' ? ' bg-[#6a68AF] text-white flex items-center px-6 py-2  mr-3 flex-1 mt-2 item ' : 'mr-3 flex-1 mt-2 item hover:bg-[#6a68AF] hover:text-white flex items-center px-6 py-2  text-gray-600' }} "
                ...
                <a class="{{ request()->segment(2) == 'services' ? ' bg-[#6a68AF] text-white flex items-center px-6 py-2  mr-3 flex-1 mt-2 item ' : 'mr-3 flex-1 mt-2 item hover:bg-[#6a68AF] hover:text-white flex items-center px-6 py-2  text-gray-600' }} "
