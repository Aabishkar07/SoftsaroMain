<div x-clock x-data="{ sidebarOpen = true }">
            ...
            <nav class=" ">
                ...
                <div class="mx-2 pt-2 space-y-1.5">
                   ...
                   {{ route('admin.blogs.index') }}
                    ...
                    <a class="{{ request()->segment(2) == 'metapages' ? ' font-semibold  rounded bg-[#8380d4] text-white flex items-center px-2 py-1.5  flex-1  item  ' : 'rounded flex-1  item hover:bg-[#6a68AF] hover:text-white flex items-center px-2 py-1.5  text-white' }} "
                        href="
                   {{ route('admin.metapages.index') }}
                     ">
                        ...
                        <span x-show="sidebarOpen" class="mx-3 text-xs">Meta Pages</span>
                    </a>
  ...
  <a class="{{ request()->segment(2) == 'portfolio' ? ' font-semibold  rounded bg-[#8380d4] text-white flex items-center px-2 py-1.5  flex-1  item  ' : 'rounded flex-1  item hover:bg-[#6a68AF] hover:text-white flex items-center px-2 py-1.5  text-white' }} "
                        ...
                        <span x-show="sidebarOpen" class="mx-3 text-xs">Portfolio</span>
                    </a>
