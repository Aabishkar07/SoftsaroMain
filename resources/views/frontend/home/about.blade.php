      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
          <div class="content ps-0 ps-lg-5">
            ...
            <ul class="fs-5">
              <li><i style="color:#6a68AF" class="bi bi-check-circle-fill pt-1"></i> <span class=""> Our Mission: To empower businesses with technology-driven solutions.</span></li>
              <li><i style="color:#6a68AF" class="bi bi-check-circle-fill pt-1"></i> <span> Our Vision: To be a global leader in IT innovation.</span></li>
              <li><i style="color:#6a68AF" class="bi bi-check-circle-fill pt-1"></i> <span>Our Values: Creativity, Integrity, Excellence, and Customer-Centricity.</span></li>
            </ul>
