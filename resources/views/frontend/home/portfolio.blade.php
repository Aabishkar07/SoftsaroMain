        ...
        @foreach ($portfolios as $portfolio)
          ...
          <div class="col-lg-4 col-md-6 portfolio-item isotope-item {{ $filterClass }}">
            <div class="portfolio-content h-100">
              <img src="{{ asset('uploads/' . $portfolio->banner_image) }}" class="img-fluid" alt="{{ $portfolio->title }}">
              <div class="portfolio-info">
                ...
                @if ($portfolio->link)
                  <a href="{{ $portfolio->link }}" target="_blank" title="Visit Project" class="details-link"><i class="bi bi-link-45deg"></i></a>
                @endif
              </div>
            </div>
          </div>
